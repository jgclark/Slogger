...
Notes:
  ...
  - Find the RSS feed for any folder by inspecting HTML source from the page and finding the RSS URL
  - Now seems to need to use a secure connection to Instapaper
